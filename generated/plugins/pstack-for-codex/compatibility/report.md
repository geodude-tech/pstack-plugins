...
- `skills/setup-pstack/SKILL.md:25`: `grok-4.6-fast-xhigh` → `pstack-fast`
- `skills/setup-pstack/SKILL.md:26`: `grok-4.6-fast-xhigh` → `pstack-fast`
- `skills/setup-pstack/SKILL.md:27`: `grok-4.6-fast-xhigh` → `pstack-fast`
