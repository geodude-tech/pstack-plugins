...
4. Pick the worker model from `swarm workers` in `~/.claude/rules/pstack-models.md` when present. Otherwise use `pstack-fast`. For a model race, name each arm's model up front.
